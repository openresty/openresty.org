...
local trans_cn = {
    ...
    ["OpenResty<sup>&reg;</sup> is an open-source web platform that integrates an enhanced Nginx core with LuaJIT, maintained by <a href=\"https://openresty.com/\">OpenResty Inc.</a>"] = "OpenResty<sup>&reg;</sup> 是一款集成了增强版 Nginx 内核与 LuaJIT 的开源 Web 平台，由 <a href=\"https://openresty.com/\">OpenResty Inc.</a> 维护。",
