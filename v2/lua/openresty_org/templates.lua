...
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/edge-k8s-upstream/?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/k8s.png" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 16 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 16 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/edge-k8s-upstream/?src=org_news" target="_blank">如何代理 Kubernetes 上游</a><span>&nbsp;'
-- line 16 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/xray-azure/?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/azure.png" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 19 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 19 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/xray-azure/?src=org_news" target="_blank">在微软的 Azure 云上部署自主部署版的 OpenResty XRay</a><span>&nbsp;'
-- line 19 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/edge-grpc-proxy/?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/grpc.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 22 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 22 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/edge-grpc-proxy/?src=org_news" target="_blank">在 OpenResty Edge 中配置 gRPC 代理</a><span>&nbsp;'
-- line 22 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n</div>'
...
-- line 13 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is now released!' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/edge-k8s-upstream/?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/k8s.png" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 16 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 16 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/edge-k8s-upstream/?src=org_news" target="_blank">How to proxy kubernetes upstream</a><span>&nbsp;'
-- line 16 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/xray-azure/?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/azure.png" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 19 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 19 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/xray-azure/?src=org_news" target="_blank">&quot;How to deploy the on-premises version of OpenResty XRay on Microsoft\'s Azure cloud&quot;</a><span>&nbsp;'
-- line 19 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/edge-grpc-proxy/?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/grpc.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 22 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 22 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/edge-grpc-proxy/?src=org_news" target="_blank">Configure gRPC proxy in OpenResty Edge</a><span>&nbsp;'
-- line 22 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n</div>'
