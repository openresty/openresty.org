...
i = i + 1 output[i] = '\n<div class="news">\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/data-share?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/data-share.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 4 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 4 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/data-share?src=org_news" target="_blank">在OpenResty服务的请求中共享数据</a><span>&nbsp;'
-- line 4 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/centos8-or-install?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/centos8-or-install.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/centos8-or-install?src=org_news" target="_blank">在 CentOS 8 上通过 dnf 安装 OpenResty</a><span>&nbsp;'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/resty-cmd?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/resty-utility.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 10 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 10 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/resty-cmd?src=org_news" target="_blank">resty 命令行工具演示</a><span>&nbsp;'
-- line 10 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
...
i = i + 1 output[i] = '\n<div class="news">\n  <div class="news-item"><a href="https://blog.openresty.com/en/data-share?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/data-share.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/data-share?src=org_news" target="_blank">Share Data Across Requests Served by OpenResty</a><span>&nbsp;'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/centos8-or-install?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/centos8-or-install.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/centos8-or-install?src=org_news" target="_blank">Install OpenResty on CentOS 8 via dnf</a><span>&nbsp;'
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/resty-cmd?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/resty-utility.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/resty-cmd?src=org_news" target="_blank">The resty Command-Line Utility Demo</a><span>&nbsp;'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="/en/ann-test-nginx-029.html">\n      <picture>\n        <source srcset="../images/test.webp" type="image/webp"/><img class="news-img" src="../images/test.png"/>\n      </picture></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 16 "news-en.tt2"
