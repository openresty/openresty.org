...
i = i + 1 output[i] = '\n<div class="news">\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/restydoc?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/restydoc.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 4 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 4 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/restydoc?src=org_news" target="_blank">在终端上用 restydoc 查看 OpenResty 文档</a><span>&nbsp;'
-- line 4 "news-cn.tt2"
...
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/data-share?src=org_news" target="_blank">在 OpenResty 中跨请求共享数据</a><span>&nbsp;'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
...
i = i + 1 output[i] = '\n<div class="news">\n  <div class="news-item"><a href="https://blog.openresty.com/en/restydoc?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/restydoc.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/restydoc?src=org_news" target="_blank">Lookup OpenResty Documentation on Terminal with restydoc</a><span>&nbsp;'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
