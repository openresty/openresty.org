...
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/ngx-off-cpu-lua-pipes/?src=org_news" target="_blank">当 Lua IPC 管道阻塞 OpenResty 或 Nginx 的事件循环</a><span>&nbsp;'
-- line 16 "news-cn.tt2"
...
-- line 19 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/qcon-2023-xray-talk/?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/qcon1.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 22 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 22 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/qcon-2023-xray-talk/?src=org_news" target="_blank">QCon 北京 2023 大会上关于深度分析和诊断 K8s 容器应用的演讲</a><span>&nbsp;'
-- line 22 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n</div>'
...
-- line 19 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/dynamic-tracing-part-2/?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/trace_2.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 22 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 22 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/dynamic-tracing-part-2/?src=org_news" target="_blank">The Wonderland of Dynamic Tracing (Part 2 of 3)</a><span>&nbsp;'
-- line 22 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n</div>'
