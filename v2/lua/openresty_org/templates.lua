...
i = i + 1 output[i] = '\n<div class="news">\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/or-lua-module?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/module-cells.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 4 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 4 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/or-lua-module?src=org_news" target="_blank">为 OpenResty 应用编写你自己的 Lua 模块</a><span>&nbsp;'
-- line 4 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/or-hello-world?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/hello-world-http.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/or-hello-world?src=org_news" target="_blank">使用 OpenResty 实现”你好世界” HTTP 示例</a><span>&nbsp;'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/openresty-ann-1.19.3.1?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/openresty-logo.png" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 10 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 10 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/openresty-ann-1.19.3.1?src=org_news" target="_blank">OpenResty 1.19.3.1 正式版发布 &amp; 线上分享会回顾</a><span>&nbsp;'
-- line 10 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
...
i = i + 1 output[i] = '\n<div class="news">\n  <div class="news-item"><a href="https://blog.openresty.com/en/or-lua-module?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/module-cells.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/or-lua-module?src=org_news" target="_blank">Write Your Own Lua Modules for OpenResty Applications</a><span>&nbsp;'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/or-hello-world?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/hello-world-http.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/or-hello-world?src=org_news" target="_blank">Hello World HTTP Example in OpenResty</a><span>&nbsp;'
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/openresty-ann-1.19.3.1?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/openresty-logo.png" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/openresty-ann-1.19.3.1?src=org_news" target="_blank">OpenResty 1.19.3.1 released</a><span>&nbsp;'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="/en/ann-test-nginx-029.html">\n      <picture>\n        <source srcset="../images/test.webp" type="image/webp"/><img class="news-img" src="../images/test.png"/>\n      </picture></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 16 "news-en.tt2"
