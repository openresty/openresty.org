...
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/edge-new-proxy?src=org_news" target="_blank">Setup a Simplest Reverse Proxy and Load Blancer with OpenResty Edge</a><span>&nbsp;'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
