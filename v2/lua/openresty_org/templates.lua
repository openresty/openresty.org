...
i = i + 1 output[i] = '&nbsp;</strong><a href="ann-1021004001rc1.html">OpenResty 1.24.1.1rc1</a><span>&nbsp;'
-- line 7 "news-cn.tt2"
...
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is now released!' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/edge-config-release?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/edge-releases.png" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/edge-config-release?src=org_news" target="_blank">Gateway Config\'s Version Control &amp; Release Management in OpenResty Edge</a><span>&nbsp;'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
...
-- line 13 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/showman-google?src=org_news" target="_blank">Auto-Generate Demo Videos for Google Search from Screenplay Docs (via OpenResty Showman)</a><span>&nbsp;'
-- line 13 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
