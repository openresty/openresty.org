...
i = i + 1 output[i] = '\n<div class="news">\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/luajit-bytecode?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/luajit-bytecode.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 4 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 4 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/luajit-bytecode?src=org_news" target="_blank">预编译 Lua 模块到 LuaJIT 字节码中以加快 OpenResty 启动速度</a><span>&nbsp;'
-- line 4 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/time-lua?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/time-lua.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/time-lua?src=org_news" target="_blank">在 OpenResty 中正确地测量 Lua 代码的执行时间</a><span>&nbsp;'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
...
i = i + 1 output[i] = '\n<div class="news">\n  <div class="news-item"><a href="https://blog.openresty.com/en/luajit-bytecode?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/luajit-bytecode.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/luajit-bytecode?src=org_news" target="_blank">Precompile Lua Modules into LuaJIT Bytecode to Speedup OpenResty Startup</a><span>&nbsp;'
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/time-lua?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/time-lua.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/time-lua?src=org_news" target="_blank">Timing Lua Code Correctly in OpenResty</a><span>&nbsp;'
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
