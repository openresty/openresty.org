...
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is now released!' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/ylang-intro-part2/?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/ylang-part2.png" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/ylang-intro-part2/?src=org_news" target="_blank">Ylang: Universal Language for eBPF, Stap+, GDB, and More (Part 2)</a><span>&nbsp;'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/ylang-intro-part1/?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/ylang-part1.png" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 13 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 13 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/ylang-intro-part1/?src=org_news" target="_blank">Ylang: Universal Language for eBPF, Stap+, GDB, and More (Part 1)</a><span>&nbsp;'
-- line 13 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
