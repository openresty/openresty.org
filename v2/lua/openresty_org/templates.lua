...
i = i + 1 output[i] = '\n<div class="news">\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/time-lua?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/hello-world-http.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 4 "news-cn.tt2"
