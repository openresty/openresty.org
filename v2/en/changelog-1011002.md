<!---
    ...
    @description   Complete change log for OpenResty® 1.11.2, listing updates and fixes to the Nginx core, LuaJIT, and bundled components.
--->
...
Dejiang Zhu for the patch.
    ...
    * bugfix: segfaults might happen when calling [ngx.log()](https://github.com/openresty/lua-nginx-module#ngxlog) in [ssl_certificate_by_lua*](https://github.com/openresty/lua-nginx-module#ssl_certificate_by_lua_block) and [error_log](https://nginx.org/r/error_log) was configured with syslog. thanks Jonathan Serafini and Greg Karékinian for the report.
