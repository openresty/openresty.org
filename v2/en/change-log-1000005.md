...
This release is almost the same as 1.0.5.1rc14, but upgraded [Lua Nginx Module](lua-nginx-module/) to v0.3.0.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc22.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to 0.2.1rc21.
...
* upgraded [Echo Nginx Module](echo-nginx-module/) to 0.37rc2
...
* now we bundle [Lua Rds Parser Library](lua-rds-parser-library/) and enable it by default.
* added the `--without-lua_rds_parser` option to disable the [Lua Rds Parser Library](lua-rds-parser-library/) bundled.
* now we bundle [Rds Csv Nginx Module](rds-csv-nginx-module/) and enable it by default.
* added the `--without-http_rds_csv_module` option to disable [Rds Csv Nginx Module](rds-csv-nginx-module/).

#  Mainline Version 1.0.5.1rc11 - 30 August 2011
* upgraded [Rds Json Nginx Module](rds-json-nginx-module/) to v0.12rc2
...
* upgraded [Lua Redis Parser Library](lua-redis-parser-library/) to 0.09rc5.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc19.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc18.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc17.
    * now we enable `ngx.re.*` regex API in `set_by_lua*` too.

#  Mainline Version 1.0.5.1rc6 - 25 August 2011
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc16.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc15.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc14.
    * added support for the optional `ctx` argument to `ngx.re.match`.

#  Mainline Version 1.0.5.1rc3 - 24 August 2011
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc13.
...
* upgraded [Drizzle Nginx Module](drizzle-nginx-module/) to v0.1.1rc4
    * added new wiki documentation page: http://wiki.nginx.org/NginxHttpDrizzleModule
    * documented the `$drizzle_thread_id` variable.
    * added lots of debug outputs (enabled by the `--with-debug` option while building [Nginx](nginx/) or [OpenResty](openresty/)), inspired by github issue #10.

#  Mainline Version 1.0.5.1rc2 - 18 August 2011
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc12.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc11.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc9.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc8.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc7.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to v0.2.1rc5.
...
* now we bundle the [Lua Redis Parser Library](lua-redis-parser-library/) with us and it is enabled by default. tested on Linux i386, Linux x86_64, Mac OS X, FreeBSD 8.2 i386, and Solaris 11.
* added the new option `--without-lua_redis_parser` to the `./configure` script.

#  Mainline Version 1.0.5.0rc2 - 10 August 2011
* now we bundle the [Lua Cjson Library](lua-cjson-library/) with us and it is enabled by default. tested on Linux i386, Linux x86_64, Mac OS X, FreeBSD 8.2 i386, and Solaris 11.
