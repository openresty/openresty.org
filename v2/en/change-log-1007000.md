...
* upgraded the [Nginx](nginx/) core to 1.7.0.
    * see the changes here: http://nginx.org/en/CHANGES
* feature: bundled new Lua library, [Lua Resty Lrucache Library](lua-resty-lrucache-library/), which is also enabled by default. see https://github.com/openresty/lua-resty-lrucache#readme for more details. thanks Shuxin Yang for the help.
* upgraded [LuaJIT](luajit/) to v2.1-20140607: https://github.com/openresty/luajit2/tags
...
* upgraded [Lua Resty Core Library](lua-resty-core-library/) to 0.0.7.
...
* upgraded [Lua Nginx Module](lua-nginx-module/) to 0.9.8.
    ...
    * bugfix: nginx does not guarentee the parent pointer of the rbtree root is meaningful, which could lead to inifinite loops when [Lua Nginx Module](lua-nginx-module/) tried to abort pending timers prematurely (upon worker exit). thanks pengqi for the report.
    ...
    * feature: added pure C API functions to support the new FFI-based Lua API implemented in [Lua Resty Core Library](lua-resty-core-library/).
...
* upgraded [Srcache Nginx Module](srcache-nginx-module/) to 0.27.
...
See [Change Log1005012](change-log-1005012/) for change log for [OpenResty](openresty/) 1.5.12.x.
