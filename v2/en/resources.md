...
* An Introduction To OpenResty (nginx + lua) - Part 1, by Karl Seguin
     ...
     https:///openmymind.net/An-Introduction-To-OpenResty-Nginx-Lua/
...
* Dynamic CDN, by Ankit Jain
     ...
     https:///engineering.wingify.com/posts/dynamic-cdn/
...
Diaz-Gonzalez
     ...
     https:///seatgeek.com/blog/dev/oauth-support-for-nginx-with-lua
...
* The [Nginx](nginx.html) Session Module, by smallfish
     ...
     https:///chenxiaoyu.org/2011/11/09/nginx-session/
* Nginx-Lua HTTP 401 Basic Authentication, by smallfish

     https:///chenxiaoyu.org/2012/02/08/nginx-lua-401-auth/
* [Nginx](nginx.html) Variable Tutorials, by agentzh

     https:///blog.sina.com.cn/openresty
* [Nginx](nginx.html) & Lua, by laowang

     https:///huoding.com/2012/08/31/156
* Implementing a simple server-push solution, by laowang

     https:///huoding.com/2012/09/28/174
