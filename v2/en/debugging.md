...
Lua development, you can put a Lua [pcall](https://www.lua.org/manual/5.1/manual.html#pdf-pcall) call
...
During Lua code development, you can disable the [Lua code cache](https://wiki.nginx.org/HttpLuaModule#lua_code_cache) temporarily
...
[Test::Nginx](https://search.cpan.org/perldoc?Test%3A%3ANginx) test scaffold
...
[systemtap](https://sourceware.org/systemtap/), which can be used to inspect
