<!---
    @title         变更日志 1.0.10
    @description   OpenResty® 1.0.10 版本的完整变更日志，记录 Nginx 核心、LuaJIT 及各 lua-resty-* 组件的更新与修复。
    @creator       Yichun Zhang
    @created       2012-05-13 13:46 GMT
...
* upgraded [Lua Nginx Module](lua-nginx-module.html) to 0.4.1rc4.
    * bugfix: `ngx_http_lua_header_filter_init` was called with an argument which actually accepts none. this could cause compilation errors at least with gcc 4.3.4 as reported in github [issue #80](https://github.com/chaoslawful/lua-nginx-module/issues/80). thanks bigplum (Simon).
