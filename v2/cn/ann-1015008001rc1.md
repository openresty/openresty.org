<!---
    @title         OpenResty 1.15.8.1 RC1 发布
    @description   OpenResty 1.15.8.1 RC1 候选版本发布，供社区测试：基于 Nginx 1.15.8 核心，新增 ARM64 支持，并引入 lua-resty-shell、lua-resty-signal、lua-tablepool 等库。
--->
